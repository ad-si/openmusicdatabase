!function () {
	...
	function tenorTrombone() {
		...
		var $piano, $trombone, $cont = ''

		for (var $i = -34; $i < 2; $i++) {
			$cont += '<div class="slide">'

			$cont += '<div class="key">' + $piano[$i] + ' </div>' +
				'<div class="valve" style="height:' + ($trombone[$i][0] * 20) + 'px;">' +
				'<span class="num">' + $trombone[$i][0] + '</span>' +
				'</div>'

			if ($trombone[$i][1]) {
				$cont += '<div class= "valve alt" style = "height:' +
					($trombone[$i][1] * 20) + 'px;" >' +
					'<span class="num">' +
					$trombone[$i][1] +
					'</span> < /div>'
	...
	function tenorBassTrombone() {
		var $piano, $tenorbasstrombone, $cont = ''
	...
	function tenorSaxophone() {
		...
		for (var $i = -17; $i < 30; $i++) {
			...
			$cont += '<div class="valves" ><div class="key">' + $piano[$i] +
				'</div></div><br />'
